...
(function () {
  ...
  var tx = new Float32Array(4);
  var ty = new Float32Array(4);

  var bx = new Float32Array(4);
  var by = new Float32Array(4);
  ...
  var lpx = new Float32Array(16);
  var lpy = new Float32Array(16);
...
/* ============================================================
   زر نسخ اسم المستخدم في Telegram
   ============================================================ */
(function () {
  "use strict";
  ...
  /* إذا العناصر غير موجودة، لا ندير والو */
  if (!btn || !user) {
    return;
  }
