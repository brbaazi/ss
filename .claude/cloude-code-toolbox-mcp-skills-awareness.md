...
_Generated: 2026-08-12T13:32:59.429Z_
...
Workspace `mcp.json` _(folder: arabetrading site)_

- **c:\Users\Ce_Pc\Desktop\arabetrading site\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Ce_Pc\.claude.json** — _File missing_
